        ...
        <div className="cdContainer">
            ...
            <div className="cdInfoContainer">
                ...
                <div className="cdButtons">
                        <NavLink to={card.demo}><button className="DemoButton">Link to Demo</button></NavLink>
                        <NavLink to={card.code}><button className="CodeButton"><img src={githubLOGO} alt="" /> Link to Code</button></NavLink>
                </div>
            </div>
        </div>
    )
